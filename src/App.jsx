...
const solveLogic = async (players, logs, impostorCount) => {
    try {
        ...
        return [{
            rank: 0,
            impostors: [],
            reason: ["无法连接到后端服务器", "请确保 python app.py 正在运行", "检查端口 5000 是否开放"]
        }];
    }
};
...
export default function App() {
    ...
    const handleResetGame = () => {
        // 重置日志和分析结果，保留玩家设置（为了方便下局直接开始），如果想清空玩家可加 setPlayers([])
    ...
    const renderSetup = () => (
        <div className="flex flex-col items-center justify-center h-full space-y-8 animate-fade-in">
            ...
            <button
                ...
                className="px-12 py-4 bg-cyan-600 hover:bg-cyan-500 text-black font-black text-xl rounded-full shadow-[0_0_20px_rgba(8,145,178,0.5)] transition-all hover:scale-105 active:scale-95 flex items-center space-x-3"
            >
                <Play size={24} />
                <span>系统初始化</span>
            </button>
        ...
        <div className="grid grid-cols-12 gap-4 h-full p-4">
            ...
            <div className="col-span-6 flex flex-col space-y-4">
                ...
                <div className="flex-1 bg-gray-950 rounded-2xl border border-gray-800 relative overflow-hidden group">
                    ...
                    {/* Dynamic Content based on Active Action */}
                    {!activeAction ? (
                        ...
                        <div className="absolute inset-0 p-6 flex flex-col animate-fade-in-up">
                            ...
                            {/* Step 3: Location (Where?) - Only for Saw, Body */}
            ...
            <div className="col-span-3 bg-black rounded-xl border border-gray-800 p-4 font-mono text-xs overflow-hidden flex flex-col relative">
                ...
                <div className="flex-1 overflow-y-auto space-y-2 pr-2 scrollbar-hide">
                    {logs.map((log, idx) => (
                        <div key={idx} className={`p-2 rounded border-l-2 ${log.type === 'kill' ? 'border-red-500 bg-red-900/10 text-red-300' :
    ...
    const renderAnalysis = () => (
        <div className="flex flex-col items-center justify-center h-full max-w-4xl mx-auto animate-fade-in">
            {!analysisResults ? (
                ...
                <div className="w-full space-y-6">
                    ...
                    <div className="grid gap-6">
                        {analysisResults.map((result, idx) => (
                            <div key={idx} className="bg-gray-900/80 border border-gray-700 rounded-xl p-6 flex items-center hover:border-cyan-500/50 transition-colors">
                                ...
                                <div className="h-12 w-1 bg-gray-800 mx-6" />
                    ...
                    <div className="flex gap-4 mt-8 mx-auto w-full justify-center">
                        <button
